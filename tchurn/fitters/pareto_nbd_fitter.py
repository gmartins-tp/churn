...
from tchurn.fitters import BaseFitter
from tchurn.utils import _check_inputs, _scale_time
from tchurn.generate_data import pareto_nbd_model
    ...
    def _fit(
        ...
        **kwargs
        ...
        if iterative_fitting <= 0:
            raise ValueError("iterative_fitting parameter should be greater than 0 as of tchurn v0.2.1")
