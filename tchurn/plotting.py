...
import numpy as np
import pandas as pd
from tchurn.utils import calculate_alive_path, expected_cumulative_transactions
...
def plot_calibration_purchases_vs_holdout_purchases(
    ...
    This currently relies too much on the tchurn.util calibration_and_holdout_data function.
...
def plot_transaction_rate_heterogeneity(
    ...
    **kwargs
    ...
    ----------
    model: tchurn model
        A fitted tchurn model, for now only for BG/NBD
